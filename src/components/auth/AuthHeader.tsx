        ...
        <View className="items-center mt-10 mb-6">
            {isIcon && (
                <View className="bg-blue-50/50 border-blue-200 dark:bg-white/10 dark:border-white/20 p-4 rounded-full mb-6 border">
                    <Ionicons name={isDark ? "moon-outline" : "sunny-outline"} size={48} color={isDark ? "#bae6fd" : "#1e3a8a"}/>
                </View>
            )}


            <Text className="text-[#1e3a8a] dark:text-white text-4xl font-extrabold text-center px-4 tracking-tight">
                {title}
            </Text>
